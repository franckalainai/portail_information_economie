...
urlpatterns = [
    ...
    path('rubriques/publications/', views.rubriques_publications, name="rubriques_publications"),
    ...
    path('actualite/<slug:post>/', views.actualite_detail, name='actualite_detail'),
